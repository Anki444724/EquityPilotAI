...
class NSEIndiaProvider(BaseMarketProvider):
    ...
    def __init__(self, policy: RetryPolicy | None = None) -> None:
        ...
        super().__init__(policy or RetryPolicy(
            attempts=2, backoff_base=1.5, timeout_seconds=15.0,
        ...
        for attempt in range(self.policy.attempts):
            ...
            try:
                ...
                if exc.code == 429:
                    ...
                    continue
                # 4xx (other than 404/429) and 5xx: fall through so the next
                # provider gets a turn rather than burning the whole chain.
                raise ProviderError(
